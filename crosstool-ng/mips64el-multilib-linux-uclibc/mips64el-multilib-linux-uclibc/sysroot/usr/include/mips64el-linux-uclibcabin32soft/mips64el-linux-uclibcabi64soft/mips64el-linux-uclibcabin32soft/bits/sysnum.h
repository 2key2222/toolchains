...
#define __NR_utimensat (6000 + 279)
#define SYS_utimensat __NR_utimensat
#undef __NR_signalfd
#define __NR_signalfd (6000 + 280)
#define SYS_signalfd __NR_signalfd
#undef __NR_timerfd
#define __NR_timerfd (6000 + 281)
#define SYS_timerfd __NR_timerfd
#undef __NR_eventfd
#define __NR_eventfd (6000 + 282)
#define SYS_eventfd __NR_eventfd
#undef __NR_fallocate
#define __NR_fallocate (6000 + 283)
#define SYS_fallocate __NR_fallocate
#undef __NR_timerfd_create
#define __NR_timerfd_create (6000 + 284)
#define SYS_timerfd_create __NR_timerfd_create
#undef __NR_timerfd_gettime
#define __NR_timerfd_gettime (6000 + 285)
#define SYS_timerfd_gettime __NR_timerfd_gettime
#undef __NR_timerfd_settime
#define __NR_timerfd_settime (6000 + 286)
#define SYS_timerfd_settime __NR_timerfd_settime
#undef __NR_signalfd4
#define __NR_signalfd4 (6000 + 287)
#define SYS_signalfd4 __NR_signalfd4
#undef __NR_eventfd2
#define __NR_eventfd2 (6000 + 288)
#define SYS_eventfd2 __NR_eventfd2
#undef __NR_epoll_create1
#define __NR_epoll_create1 (6000 + 289)
#define SYS_epoll_create1 __NR_epoll_create1
#undef __NR_dup3
#define __NR_dup3 (6000 + 290)
#define SYS_dup3 __NR_dup3
#undef __NR_pipe2
#define __NR_pipe2 (6000 + 291)
#define SYS_pipe2 __NR_pipe2
#undef __NR_inotify_init1
#define __NR_inotify_init1 (6000 + 292)
#define SYS_inotify_init1 __NR_inotify_init1
#undef __NR_preadv
#define __NR_preadv (6000 + 293)
#define SYS_preadv __NR_preadv
#undef __NR_pwritev
#define __NR_pwritev (6000 + 294)
#define SYS_pwritev __NR_pwritev
#undef __NR_rt_tgsigqueueinfo
#define __NR_rt_tgsigqueueinfo (6000 + 295)
#define SYS_rt_tgsigqueueinfo __NR_rt_tgsigqueueinfo
#undef __NR_perf_event_open
#define __NR_perf_event_open (6000 + 296)
#define SYS_perf_event_open __NR_perf_event_open
#undef __NR_accept4
#define __NR_accept4 (6000 + 297)
#define SYS_accept4 __NR_accept4
#undef __NR_recvmmsg
#define __NR_recvmmsg (6000 + 298)
#define SYS_recvmmsg __NR_recvmmsg
#undef __NR_getdents64
#define __NR_getdents64 (6000 + 299)
#define SYS_getdents64 __NR_getdents64
#undef __NR_fanotify_init
#define __NR_fanotify_init (6000 + 300)
#define SYS_fanotify_init __NR_fanotify_init
#undef __NR_fanotify_mark
#define __NR_fanotify_mark (6000 + 301)
#define SYS_fanotify_mark __NR_fanotify_mark
#undef __NR_prlimit64
#define __NR_prlimit64 (6000 + 302)
#define SYS_prlimit64 __NR_prlimit64
#undef __NR_name_to_handle_at
#define __NR_name_to_handle_at (6000 + 303)
#define SYS_name_to_handle_at __NR_name_to_handle_at
#undef __NR_open_by_handle_at
#define __NR_open_by_handle_at (6000 + 304)
#define SYS_open_by_handle_at __NR_open_by_handle_at
#undef __NR_clock_adjtime
#define __NR_clock_adjtime (6000 + 305)
#define SYS_clock_adjtime __NR_clock_adjtime
#undef __NR_syncfs
#define __NR_syncfs (6000 + 306)
#define SYS_syncfs __NR_syncfs
#undef __NR_sendmmsg
#define __NR_sendmmsg (6000 + 307)
#define SYS_sendmmsg __NR_sendmmsg
#undef __NR_setns
#define __NR_setns (6000 + 308)
#define SYS_setns __NR_setns
#undef __NR_process_vm_readv
#define __NR_process_vm_readv (6000 + 309)
#define SYS_process_vm_readv __NR_process_vm_readv
#undef __NR_process_vm_writev
#define __NR_process_vm_writev (6000 + 310)
#define SYS_process_vm_writev __NR_process_vm_writev
#undef __NR_kcmp
#define __NR_kcmp (6000 + 311)
#define SYS_kcmp __NR_kcmp
#undef __NR_finit_module
#define __NR_finit_module (6000 + 312)
#define SYS_finit_module __NR_finit_module
#undef __NR_sched_setattr
#define __NR_sched_setattr (6000 + 313)
#define SYS_sched_setattr __NR_sched_setattr
#undef __NR_sched_getattr
#define __NR_sched_getattr (6000 + 314)
#define SYS_sched_getattr __NR_sched_getattr
#undef __NR_renameat2
#define __NR_renameat2 (6000 + 315)
#define SYS_renameat2 __NR_renameat2
#undef __NR_seccomp
#define __NR_seccomp (6000 + 316)
#define SYS_seccomp __NR_seccomp
#undef __NR_getrandom
#define __NR_getrandom (6000 + 317)
#define SYS_getrandom __NR_getrandom
#undef __NR_memfd_create
#define __NR_memfd_create (6000 + 318)
#define SYS_memfd_create __NR_memfd_create
#undef __NR_bpf
#define __NR_bpf (6000 + 319)
#define SYS_bpf __NR_bpf
#undef __NR_execveat
#define __NR_execveat (6000 + 320)
#define SYS_execveat __NR_execveat
#undef __NR_userfaultfd
#define __NR_userfaultfd (6000 + 321)
#define SYS_userfaultfd __NR_userfaultfd
#undef __NR_membarrier
#define __NR_membarrier (6000 + 322)
#define SYS_membarrier __NR_membarrier
#undef __NR_mlock2
#define __NR_mlock2 (6000 + 323)
#define SYS_mlock2 __NR_mlock2
#undef __NR_copy_file_range
#define __NR_copy_file_range (6000 + 324)
#define SYS_copy_file_range __NR_copy_file_range
#undef __NR_preadv2
#define __NR_preadv2 (6000 + 325)
#define SYS_preadv2 __NR_preadv2
#undef __NR_pwritev2
#define __NR_pwritev2 (6000 + 326)
#define SYS_pwritev2 __NR_pwritev2
#undef __NR_pkey_mprotect
#define __NR_pkey_mprotect (6000 + 327)
#define SYS_pkey_mprotect __NR_pkey_mprotect
#undef __NR_pkey_alloc
#define __NR_pkey_alloc (6000 + 328)
#define SYS_pkey_alloc __NR_pkey_alloc
#undef __NR_pkey_free
#define __NR_pkey_free (6000 + 329)
#define SYS_pkey_free __NR_pkey_free
#undef __NR_statx
#define __NR_statx (6000 + 330)
#define SYS_statx __NR_statx
#undef __NR_rseq
#define __NR_rseq (6000 + 331)
#define SYS_rseq __NR_rseq
#undef __NR_io_pgetevents
#define __NR_io_pgetevents (6000 + 332)
