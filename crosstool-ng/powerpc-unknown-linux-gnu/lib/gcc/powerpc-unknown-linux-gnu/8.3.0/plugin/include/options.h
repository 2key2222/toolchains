...
#define OPTION_MASK_FPRND (HOST_WIDE_INT_1U << 12)
#define OPTION_MASK_DFP (HOST_WIDE_INT_1U << 13)
#define OPTION_MASK_SOFT_FLOAT (HOST_WIDE_INT_1U << 14)
#define OPTION_MASK_HTM (HOST_WIDE_INT_1U << 15)
#define OPTION_MASK_ISEL (HOST_WIDE_INT_1U << 16)
#define OPTION_MASK_MFCRF (HOST_WIDE_INT_1U << 17)
#define OPTION_MASK_MFPGPR (HOST_WIDE_INT_1U << 18)
#define OPTION_MASK_MINIMAL_TOC (HOST_WIDE_INT_1U << 19)
#define OPTION_MASK_MODULO (HOST_WIDE_INT_1U << 20)
#define OPTION_MASK_MULHW (HOST_WIDE_INT_1U << 21)
#define OPTION_MASK_MULTIPLE (HOST_WIDE_INT_1U << 22)
#define OPTION_MASK_NO_UPDATE (HOST_WIDE_INT_1U << 23)
#define OPTION_MASK_POPCNTB (HOST_WIDE_INT_1U << 24)
#define OPTION_MASK_POPCNTD (HOST_WIDE_INT_1U << 25)
#define OPTION_MASK_P8_FUSION (HOST_WIDE_INT_1U << 26)
#define OPTION_MASK_P8_FUSION_SIGN (HOST_WIDE_INT_1U << 27)
#define OPTION_MASK_P8_VECTOR (HOST_WIDE_INT_1U << 28)
#define OPTION_MASK_P9_FUSION (HOST_WIDE_INT_1U << 29)
#define OPTION_MASK_P9_MINMAX (HOST_WIDE_INT_1U << 30)
#define OPTION_MASK_P9_MISC (HOST_WIDE_INT_1U << 31)
#define OPTION_MASK_P9_VECTOR (HOST_WIDE_INT_1U << 32)
#define OPTION_MASK_PPC_GFXOPT (HOST_WIDE_INT_1U << 33)
#define OPTION_MASK_PPC_GPOPT (HOST_WIDE_INT_1U << 34)
#define OPTION_MASK_POWERPC64 (HOST_WIDE_INT_1U << 35)
#define OPTION_MASK_QUAD_MEMORY (HOST_WIDE_INT_1U << 36)
#define OPTION_MASK_QUAD_MEMORY_ATOMIC (HOST_WIDE_INT_1U << 37)
#define OPTION_MASK_RECIP_PRECISION (HOST_WIDE_INT_1U << 38)
#define OPTION_MASK_RELOCATABLE (HOST_WIDE_INT_1U << 39)
#define OPTION_MASK_SAVE_TOC_INDIRECT (HOST_WIDE_INT_1U << 40)
#define OPTION_MASK_STRICT_ALIGN (HOST_WIDE_INT_1U << 41)
#define OPTION_MASK_TOC_FUSION (HOST_WIDE_INT_1U << 42)
#define OPTION_MASK_VSX (HOST_WIDE_INT_1U << 43)
#if defined(HOST_BITS_PER_WIDE_INT) && 44 > HOST_BITS_PER_WIDE_INT
...
enum opt_code
{
  ...
  OPT_m32 = 1191,                            /* -m32 */
  OPT_m64 = 1192,                            /* -m64 */
  OPT_mabi_altivec = 1193,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1194,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1195,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1196,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1197,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1198,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1199,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1200,                /* -mabi=no-altivec */
  OPT_mads = 1201,                           /* -mads */
  OPT_maix_struct_return = 1202,             /* -maix-struct-return */
  OPT_malign_ = 1203,                        /* -malign- */
  OPT_malign_branch_targets = 1204,          /* -malign-branch-targets */
  OPT_mallow_movmisalign = 1205,             /* -mallow-movmisalign */
  OPT_maltivec = 1206,                       /* -maltivec */
  OPT_maltivec_be = 1207,                    /* -maltivec=be */
  OPT_maltivec_le = 1208,                    /* -maltivec=le */
  OPT_malways_hint = 1209,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 1210,       /* -mavoid-indexed-addresses */
  OPT_mbig = 1211,                           /* -mbig */
  OPT_mbig_endian = 1212,                    /* -mbig-endian */
  OPT_mbionic = 1213,                        /* -mbionic */
  OPT_mbit_align = 1214,                     /* -mbit-align */
  OPT_mbit_word = 1215,                      /* -mbit-word */
  OPT_mblock_compare_inline_limit_ = 1216,   /* -mblock-compare-inline-limit= */
  OPT_mblock_compare_inline_loop_limit_ = 1217,/* -mblock-compare-inline-loop-limit= */
  OPT_mblock_move_inline_limit_ = 1218,      /* -mblock-move-inline-limit= */
  OPT_mbss_plt = 1219,                       /* -mbss-plt */
  OPT_mcall_ = 1220,                         /* -mcall- */
  OPT_mcmpb = 1221,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1222,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1223,                          /* -mcpu= */
  OPT_mcrypto = 1224,                        /* -mcrypto */
  OPT_mdebug_ = 1225,                        /* -mdebug= */
  /* OPT_mdirect_move = 1226, */             /* -mdirect-move */
  OPT_mdlmzb = 1227,                         /* -mdlmzb */
  OPT_mdouble_float = 1228,                  /* -mdouble-float */
  OPT_meabi = 1229,                          /* -meabi */
  OPT_mefficient_unaligned_vsx = 1230,       /* -mefficient-unaligned-vsx */
  OPT_memb = 1231,                           /* -memb */
  OPT_mfloat128 = 1232,                      /* -mfloat128 */
  OPT_mfloat128_convert = 1233,              /* -mfloat128-convert */
  OPT_mfloat128_hardware = 1234,             /* -mfloat128-hardware */
  OPT_mfold_gimple = 1235,                   /* -mfold-gimple */
  OPT_mfp_in_toc = 1236,                     /* -mfp-in-toc */
  OPT_mfprnd = 1237,                         /* -mfprnd */
  OPT_mfpu_ = 1238,                          /* -mfpu= */
  OPT_mfriz = 1239,                          /* -mfriz */
  OPT_mfull_toc = 1240,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1241, */              /* -mfused-madd */
  /* OPT_mgen_cell_microcode = 1242, */      /* -mgen-cell-microcode */
  OPT_mglibc = 1243,                         /* -mglibc */
  OPT_mgnu_attribute = 1244,                 /* -mgnu-attribute */
  OPT_mhard_dfp = 1245,                      /* -mhard-dfp */
  OPT_mhard_float = 1246,                    /* -mhard-float */
  OPT_mhtm = 1247,                           /* -mhtm */
  OPT_minsert_sched_nops_ = 1248,            /* -minsert-sched-nops= */
  OPT_misel = 1249,                          /* -misel */
  /* OPT_misel_no = 1250, */                 /* -misel=no */
  /* OPT_misel_yes = 1251, */                /* -misel=yes */
  OPT_mlittle = 1252,                        /* -mlittle */
  OPT_mlittle_endian = 1253,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1254,                  /* -mlong-double- */
  OPT_mlongcall = 1255,                      /* -mlongcall */
  /* OPT_mlra = 1256, */                     /* -mlra */
  OPT_mmfcrf = 1257,                         /* -mmfcrf */
  OPT_mmfpgpr = 1258,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1259,                   /* -mminimal-toc */
  OPT_mmodulo = 1260,                        /* -mmodulo */
  OPT_mmulhw = 1261,                         /* -mmulhw */
  OPT_mmultiple = 1262,                      /* -mmultiple */
  OPT_mmusl = 1263,                          /* -mmusl */
  OPT_mmvme = 1264,                          /* -mmvme */
  OPT_mnewlib = 1265,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1266,                  /* -mno-fp-in-toc */
  /* OPT_mno_string = 1267, */               /* -mno-string */
  OPT_mno_sum_in_toc = 1268,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1269,                        /* -mno-toc */
  OPT_mno_traceback = 1270,                  /* -mno-traceback */
  OPT_mno_update = 1271,                     /* -mno-update */
  OPT_moptimize_swaps = 1272,                /* -moptimize-swaps */
  OPT_mpaired = 1273,                        /* -mpaired */
  OPT_mpointers_to_nested_functions = 1274,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1275,                       /* -mpopcntb */
  OPT_mpopcntd = 1276,                       /* -mpopcntd */
  OPT_mpower8_fusion = 1277,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1278,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1279,                 /* -mpower8-vector */
  OPT_mpower9_fusion = 1280,                 /* -mpower9-fusion */
  OPT_mpower9_minmax = 1281,                 /* -mpower9-minmax */
  OPT_mpower9_misc = 1282,                   /* -mpower9-misc */
  OPT_mpower9_vector = 1283,                 /* -mpower9-vector */
  /* OPT_mpowerpc = 1284, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1285,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1286,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1287,                     /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_ = 1288,  /* -mprioritize-restricted-insns= */
  OPT_mprototype = 1289,                     /* -mprototype */
  OPT_mquad_memory = 1290,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1291,            /* -mquad-memory-atomic */
  OPT_mreadonly_in_sdata = 1292,             /* -mreadonly-in-sdata */
  OPT_mrecip = 1293,                         /* -mrecip */
  OPT_mrecip_precision = 1294,               /* -mrecip-precision */
  OPT_mrecip_ = 1295,                        /* -mrecip= */
  OPT_mregnames = 1296,                      /* -mregnames */
  OPT_mrelocatable = 1297,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1298,               /* -mrelocatable-lib */
  OPT_msave_toc_indirect = 1299,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1300,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1301,                  /* -msched-epilog */
  OPT_msched_groups = 1302,                  /* -msched-groups */
  OPT_msched_prolog = 1303,                  /* -msched-prolog */
  OPT_msdata = 1304,                         /* -msdata */
  OPT_msdata_ = 1305,                        /* -msdata= */
  OPT_msecure_plt = 1306,                    /* -msecure-plt */
  OPT_mshlib = 1307,                         /* -mshlib */
  OPT_msim = 1308,                           /* -msim */
  OPT_msimple_fpu = 1309,                    /* -msimple-fpu */
  OPT_msingle_float = 1310,                  /* -msingle-float */
  OPT_msingle_pic_base = 1311,               /* -msingle-pic-base */
  OPT_msoft_float = 1312,                    /* -msoft-float */
  OPT_mspeculate_indirect_jumps = 1313,      /* -mspeculate-indirect-jumps */
  OPT_mstack_protector_guard_offset_ = 1314, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1315,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1316,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1317,                  /* -mstrict-align */
  OPT_mstring = 1318,                        /* -mstring */
  OPT_mstring_compare_inline_limit_ = 1319,  /* -mstring-compare-inline-limit= */
  OPT_msum_in_toc = 1320,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1321,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1322,                   /* -mtls-markers */
  OPT_mtls_size_ = 1323,                     /* -mtls-size= */
  OPT_mtoc = 1324,                           /* -mtoc */
  OPT_mtoc_fusion = 1325,                    /* -mtoc-fusion */
  OPT_mtraceback_ = 1326,                    /* -mtraceback= */
  OPT_mtune_ = 1327,                         /* -mtune= */
  OPT_muclibc = 1328,                        /* -muclibc */
  OPT_mupdate = 1329,                        /* -mupdate */
  OPT_mveclibabi_ = 1330,                    /* -mveclibabi= */
  OPT_mvrsave = 1331,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1332, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1333, */              /* -mvrsave=yes */
  OPT_mvsx = 1334,                           /* -mvsx */
  OPT_mvsx_align_128 = 1335,                 /* -mvsx-align-128 */
  /* OPT_mvsx_timode = 1336, */              /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1337,             /* -mwarn-altivec-long */
  ...
  OPT_pie = 1357,                            /* -pie */
  OPT_pipe = 1358,                           /* -pipe */
  OPT_posix = 1359,                          /* -posix */
  OPT_print_file_name_ = 1360,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1361,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1362,          /* -print-multi-directory */
  OPT_print_multi_lib = 1363,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1364,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1365,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1366,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1367,               /* -print-prog-name= */
  OPT_print_search_dirs = 1368,              /* -print-search-dirs */
  OPT_print_sysroot = 1369,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1370,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1371,                        /* -profile */
  OPT_pthread = 1372,                        /* -pthread */
  OPT_quiet = 1373,                          /* -quiet */
  OPT_r = 1374,                              /* -r */
  OPT_rdynamic = 1375,                       /* -rdynamic */
  OPT_remap = 1376,                          /* -remap */
  OPT_s = 1377,                              /* -s */
  OPT_save_temps = 1378,                     /* -save-temps */
  OPT_save_temps_ = 1379,                    /* -save-temps= */
  OPT_shared = 1380,                         /* -shared */
  OPT_shared_libgcc = 1381,                  /* -shared-libgcc */
  /* OPT_specs = 1382, */                    /* -specs */
  OPT_specs_ = 1383,                         /* -specs= */
  OPT_static = 1384,                         /* -static */
  OPT_static_libasan = 1385,                 /* -static-libasan */
  OPT_static_libgcc = 1386,                  /* -static-libgcc */
  OPT_static_libgfortran = 1387,             /* -static-libgfortran */
  OPT_static_libgo = 1388,                   /* -static-libgo */
  OPT_static_liblsan = 1389,                 /* -static-liblsan */
  OPT_static_libmpx = 1390,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1391,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1392,               /* -static-libstdc++ */
  OPT_static_libtsan = 1393,                 /* -static-libtsan */
  OPT_static_libubsan = 1394,                /* -static-libubsan */
  OPT_static_pie = 1395,                     /* -static-pie */
  /* OPT_std_c__03 = 1396, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1397, */                /* -std=c++0x */
  OPT_std_c__11 = 1398,                      /* -std=c++11 */
  OPT_std_c__14 = 1399,                      /* -std=c++14 */
  OPT_std_c__17 = 1400,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1401, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1402, */                /* -std=c++1z */
  OPT_std_c__2a = 1403,                      /* -std=c++2a */
  OPT_std_c__98 = 1404,                      /* -std=c++98 */
  OPT_std_c11 = 1405,                        /* -std=c11 */
  OPT_std_c17 = 1406,                        /* -std=c17 */
  /* OPT_std_c18 = 1407, */                  /* -std=c18 */
  /* OPT_std_c1x = 1408, */                  /* -std=c1x */
  /* OPT_std_c89 = 1409, */                  /* -std=c89 */
  OPT_std_c90 = 1410,                        /* -std=c90 */
  OPT_std_c99 = 1411,                        /* -std=c99 */
  /* OPT_std_c9x = 1412, */                  /* -std=c9x */
  OPT_std_f2003 = 1413,                      /* -std=f2003 */
  OPT_std_f2008 = 1414,                      /* -std=f2008 */
  OPT_std_f2008ts = 1415,                    /* -std=f2008ts */
  OPT_std_f2018 = 1416,                      /* -std=f2018 */
  OPT_std_f95 = 1417,                        /* -std=f95 */
  OPT_std_gnu = 1418,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1419, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1420, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1421,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1422,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1423,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1424, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1425, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1426,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1427,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1428,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1429,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1430, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1431, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1432, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1433,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1434,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1435, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1436, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1437,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1438, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1439, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1440, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1441, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1442, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1443,                     /* -std=legacy */
  OPT_symbolic = 1444,                       /* -symbolic */
  OPT_t = 1445,                              /* -t */
  OPT_time = 1446,                           /* -time */
  OPT_time_ = 1447,                          /* -time= */
  OPT_traditional = 1448,                    /* -traditional */
  OPT_traditional_cpp = 1449,                /* -traditional-cpp */
  OPT_trigraphs = 1450,                      /* -trigraphs */
  OPT_u = 1451,                              /* -u */
  OPT_undef = 1452,                          /* -undef */
  OPT_v = 1453,                              /* -v */
  OPT_version = 1454,                        /* -version */
  OPT_w = 1455,                              /* -w */
  OPT_wrapper = 1456,                        /* -wrapper */
  OPT_x = 1457,                              /* -x */
  OPT_z = 1458,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
