...
#define HAVE_nesi3 (TARGET_32BIT)
#define HAVE_nedi3 (TARGET_64BIT)
...
#define HAVE_tablejumpdi (TARGET_64BIT && rs6000_speculate_indirect_jumps)
#define HAVE_tablejumpdi_nospec (TARGET_64BIT && !rs6000_speculate_indirect_jumps)
